...
import 'package:ppob_app/features/paspor/presentation/pages/paspor_empat_berhasil.dart';
import 'package:ppob_app/features/paspor/presentation/pages/paspor_empat_gagal.dart';

class PasporTigaPage extends StatefulWidget {
  final String billingCode;
  final String totalTagihan;

  const PasporTigaPage({
    super.key,
  ...
  @override
  State<PasporTigaPage> createState() => _PasporTigaPageState();
}

class _PasporTigaPageState extends State<PasporTigaPage> {
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PasporEmpatBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PasporEmpatGagal(
              billingCode: widget.billingCode,
              totalTagihan: widget.totalTagihan,
            ),
          ),
