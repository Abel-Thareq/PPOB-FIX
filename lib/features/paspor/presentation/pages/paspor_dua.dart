...
import 'package:ppob_app/features/paspor/presentation/pages/paspor_tiga.dart';

class PasporDuaPage extends StatefulWidget {
  ...
  @override
  State<PasporDuaPage> createState() => _PasporDuaPageState();
}

class _PasporDuaPageState extends State<PasporDuaPage> {
  ...
  final String layanan = "Paspor Biasa 48 Halaman";
  final String lokasiKantor = "Kanim Semarang";
  final String tanggalJanji = "15 September 2026";
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DetailRow("Jenis Layanan", layanan),
                        _DetailRow("Lokasi Kantor", lokasiKantor),
                        _DetailRow("Tanggal Janji", tanggalJanji),
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PasporTigaPage(
