...
import 'package:ppob_app/features/pascabayar/presentation/pages/pascabayar_lima_berhasil.dart';
import 'package:ppob_app/features/pascabayar/presentation/pages/pascabayar_lima_gagal.dart';

class PascabayarEmpatPage extends StatefulWidget {
  final int nominalTagihan;
  final int biayaAdmin;
  final String namaPelanggan;
  final String nomorHp;

  const PascabayarEmpatPage({
    super.key,
  ...
  @override
  State<PascabayarEmpatPage> createState() => _PascabayarEmpatPageState();
}

class _PascabayarEmpatPageState extends State<PascabayarEmpatPage> {
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PascabayarLimaBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PascabayarLimaGagal(
              nominalTagihan: widget.nominalTagihan,
              biayaAdmin: widget.biayaAdmin,
              namaPelanggan: widget.namaPelanggan,
              nomorHp: widget.nomorHp,
