...
import 'package:ppob_app/features/pascabayar/presentation/pages/pascabayar_empat.dart';

class PascabayarTigaPage extends StatefulWidget {
  final String nomorHp;

  const PascabayarTigaPage({
    super.key,
    required this.nomorHp,
  });

  @override
  State<PascabayarTigaPage> createState() => _PascabayarTigaPageState();
}

class _PascabayarTigaPageState extends State<PascabayarTigaPage> {
  ...
  final String tipePelanggan = "RT2";
  final String periodeTagihan = "Agustus 2026";
  final int totalPeriode = 5;
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _DetailRow("", "081215633163"),
                      _DetailRow("Nomor HP", widget.nomorHp),
                      _DetailRow("Nama Pelanggan", namaPelanggan),
                      _DetailRow("Produk", tipePelanggan),
                      _DetailRow("Periode Tagihan", periodeTagihan),
              ...
              child: CustomButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PascabayarEmpatPage(
                        nomorHp: widget.nomorHp,
                        nominalTagihan: totalPembayaran,
