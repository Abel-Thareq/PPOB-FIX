...
import 'package:ppob_app/features/snpmb/presentation/pages/snpmb_empat_berhasil.dart';
import 'package:ppob_app/features/snpmb/presentation/pages/snpmb_empat_gagal.dart';

class SnpmbTigaPage extends StatefulWidget {
  ...
  @override
  State<SnpmbTigaPage> createState() => _SnpmbTigaPageState();
}

class _SnpmbTigaPageState extends State<SnpmbTigaPage> {
  String enteredPin = '';
  ...
  void _onSubmitPressed() {
    if (enteredPin.length == pinLength) {
      // Logic untuk validasi PIN
      // Gunakan 555555 untuk berhasil, 111111 untuk gagal
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SnpmbEmpatBerhasilPage(
              namaPelanggan: widget.namaPelanggan,
              jenisUjian: widget.jenisUjian,
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SnpmbEmpatGagalPage(
              namaPelanggan: widget.namaPelanggan,
              jenisUjian: widget.jenisUjian,
              tagihan: widget.tagihan,
              biayaAdmin: widget.biayaAdmin,
