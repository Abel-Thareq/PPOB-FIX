...
import 'package:ppob_app/features/Tarik%20Tunai/presentation/pages/tarik_tunaiempat.dart';

class TarikTunaiTigaPage extends StatefulWidget {
  final String jalur;
  final int nominal;
  ...
  @override
  State<TarikTunaiTigaPage> createState() => _TarikTunaiTigaPageState();
}

class _TarikTunaiTigaPageState extends State<TarikTunaiTigaPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TarikTunaiEmpatPage(
              jalur: widget.jalur,
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Terjadi masalah Jaringan Silahkan coba lagi"),
