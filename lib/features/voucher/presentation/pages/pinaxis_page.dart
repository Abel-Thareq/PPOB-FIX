...
import 'struk_axisberhasil_page.dart';
import 'struk_axisgagal_page.dart';

class PinAxisPage extends StatefulWidget {
  ...
  @override
  State<PinAxisPage> createState() => _PinAxisPageState();
}

class _PinAxisPageState extends State<PinAxisPage> {
  String _pin = "";
    ...
    if (value == "back") {
      ...
      if (_pin == "123456") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukAxisBerhasilPage(
