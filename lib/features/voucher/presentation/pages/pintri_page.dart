...
import 'struk_triberhasil_page.dart';
import 'struk_trigagal_page.dart';

class PinTriPage extends StatefulWidget {
  ...
  @override
  State<PinTriPage> createState() => _PinTriPageState();
}

class _PinTriPageState extends State<PinTriPage> {
  String _pin = "";
    ...
    if (value == "back") {
      ...
      if (_pin == "123456") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukTriBerhasilPage(
