...
class StrukTelkomselBerhasilPage extends StatelessWidget {
  final String noRef;
  ...
  const StrukTelkomselBerhasilPage({
    super.key,
    required this.noRef,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Sumber Dana dan Detail Transaksi
                _buildRow("Sumber Dana", "Saldo modipay"),
                const SizedBox(height: 12),
                _buildRow("Jenis Transaksi", "Voucher Telkomsel"),
                const SizedBox(height: 12),
