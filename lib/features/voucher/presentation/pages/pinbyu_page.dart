...
import 'struk_byuberhasil_page.dart';
import 'struk_byugagal_page.dart';

class PinByUPage extends StatefulWidget {
  ...
  @override
  State<PinByUPage> createState() => _PinByUPageState();
}

class _PinByUPageState extends State<PinByUPage> {
  String _pin = "";
    ...
    if (value == "back") {
      ...
      if (_pin == "123456") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukByUBerhasilPage(
