...
import 'struk_telkomselberhasil_page.dart';
import 'struk_telkomselgagal_page.dart';

class PinTelkomselPage extends StatefulWidget {
  final String nomorTelepon;
  final String namaPaket;
  final String harga;

  const PinTelkomselPage({
    super.key,
  ...
  @override
  State<PinTelkomselPage> createState() => _PinTelkomselPageState();
}

class _PinTelkomselPageState extends State<PinTelkomselPage> {
  String _pin = "";
    ...
    if (value == "back") {
      ...
      if (_pin == "123456") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukTelkomselBerhasilPage(
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukTelkomselGagalPage(
              noRef: _generateNoRef(),
              nomorTelepon: widget.nomorTelepon,
              harga: int.parse(widget.harga.replaceAll('.', '')),
              biayaAdmin: 0,
