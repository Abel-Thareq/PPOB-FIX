...
import 'struk_smartfrenberhasil_page.dart';
import 'struk_smartfrengagal_page.dart';

class PinSmartfrenPage extends StatefulWidget {
  final String nomorTelepon;
  final String namaPaket;
  final String harga;

  const PinSmartfrenPage({
    super.key,
  ...
  @override
  State<PinSmartfrenPage> createState() => _PinSmartfrenPageState();
}

class _PinSmartfrenPageState extends State<PinSmartfrenPage> {
  String _pin = "";
    ...
    if (value == "back") {
      ...
      if (_pin == "123456") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukSmartfrenBerhasilPage(
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => StrukSmartfrenGagalPage(
              noRef: _generateNoRef(),
              nomorTelepon: widget.nomorTelepon,
              namaPaket: widget.namaPaket,
              harga: int.parse(widget.harga.replaceAll('.', '')),
