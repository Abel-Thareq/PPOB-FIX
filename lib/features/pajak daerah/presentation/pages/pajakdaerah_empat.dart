...
import 'package:ppob_app/features/pajak%20daerah/presentation/pages/pajakdaerah_lima_berhasil.dart';
import 'package:ppob_app/features/pajak%20daerah/presentation/pages/pajakdaerah_lima_gagal.dart';

class PajakDaerahEmpatPage extends StatefulWidget {
  final String provinceName;
  final String provinceImage;
  final String cityName;
  final String tagihanNumber;

  const PajakDaerahEmpatPage({
    super.key,
  ...
  @override
  State<PajakDaerahEmpatPage> createState() => _PajakDaerahEmpatPageState();
}

class _PajakDaerahEmpatPageState extends State<PajakDaerahEmpatPage> {
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PajakDaerahBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PajakDaerahGagal(
              provinceName: widget.provinceName,
              provinceImage: widget.provinceImage,
              cityName: widget.cityName,
              tagihanNumber: widget.tagihanNumber,
