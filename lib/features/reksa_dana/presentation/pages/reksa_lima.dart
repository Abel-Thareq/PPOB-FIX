...
import 'reksa_enam_berhasil.dart'; // Sesuaikan dengan nama file yang sesuai
import 'reksa_enam_gagal.dart'; // Sesuaikan dengan nama file yang sesuai

class ReksaLimaPage extends StatefulWidget {
  ...
  @override
  State<ReksaLimaPage> createState() => _ReksaLimaPageState();
}

class _ReksaLimaPageState extends State<ReksaLimaPage> {
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ReksaEnamBerhasil(
              productName: widget.productName,
              productImage: widget.productImage,
              nominal: widget.nominal,
              perkiraanUnit: widget.perkiraanUnit,
            ),
          ),
        );
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ReksaEnamGagal(
              productName: widget.productName,
              productImage: widget.productImage,
              nominal: widget.nominal,
              perkiraanUnit: widget.perkiraanUnit,
