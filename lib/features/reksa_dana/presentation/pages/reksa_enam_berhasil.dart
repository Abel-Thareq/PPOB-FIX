...
class ReksaEnamBerhasil extends StatefulWidget {
  final String productName;
  final String productImage;
  final int nominal;
  final double perkiraanUnit;

  const ReksaEnamBerhasil({
    Key? key,
  ...
  @override
  State<ReksaEnamBerhasil> createState() => _ReksaEnamBerhasilState();
}

class _ReksaEnamBerhasilState extends State<ReksaEnamBerhasil> {
...
Jenis Transaksi: Pembelian Reksa Dana
Jenis Reksa Dana: ${widget.productName}
Nama Investor: $namaInvestor
Harga: ${_formatRupiah(widget.nominal)}
Biaya Admin: Rp0
Total Pembelian: ${_formatRupiah(widget.nominal)}
Perkiraan Unit: ${widget.perkiraanUnit.toStringAsFixed(4)}
----------------------------------------
    """;
