...
class EinvoicingEmpatBerhasil extends StatefulWidget {
  final String publisher;
  final String paymentCode;

  const EinvoicingEmpatBerhasil({
    super.key,
  ...
  @override
  State<EinvoicingEmpatBerhasil> createState() => _EinvoicingEmpatBerhasilState();
}

class _EinvoicingEmpatBerhasilState extends State<EinvoicingEmpatBerhasil> {
  // Data dummy
  final int nominalTagihan = 1500000;
  final int biayaAdmin = 0;
  final String namaPelanggan = "ABEL THAREQ";
  ...
  void _shareTransactionDetails() {
    ...
    Detail Pembayaran E-Invoicing:
    ----------------------------------------
    Tanggal: $formattedDate
    No. Ref: $noRef
    Sumber Dana: $namaPelanggan
    Jenis Transaksi: E-Invoicing
    Kode Pembayaran: ${widget.paymentCode}
    Nama WP: $namaWP
    Harga: ${formatCurrency(nominalTagihan)}
    Denda: ${formatCurrency(0)}
    Biaya Admin: ${formatCurrency(biayaAdmin)}
