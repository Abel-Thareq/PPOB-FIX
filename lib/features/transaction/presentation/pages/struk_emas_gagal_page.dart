...
// Import halaman tujuan setelah selesai
// import 'package:ppob_app/features/transaction/presentation/pages/emas2_page.dart';

class StrukEmasGagalPage extends StatefulWidget {
  final String noRef;
  final int harga;
  ...
  @override
  State<StrukEmasGagalPage> createState() => _StrukEmasGagalPageState();
}

class _StrukEmasGagalPageState extends State<StrukEmasGagalPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 8.h),
            // Menggunakan ikon dan teks untuk transaksi gagal
            Image.asset(
              'assets/images/error.png', // Pastikan path ikon gagal sudah benar
              width: 48.w,
              height: 48.w,
            ),
            SizedBox(height: 8.h),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // No. Ref disesuaikan untuk menampilkan "-" jika tidak ada
                  _buildRow(
                    "No. Ref",
                    widget.noRef.isEmpty ? '-' : widget.noRef,
                  ),
                  Padding(
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          // TODO: Implementasi untuk tombol "Coba Lagi"
                        },
                        child: const Text(
                          "Coba Lagi",
                          style: TextStyle(
