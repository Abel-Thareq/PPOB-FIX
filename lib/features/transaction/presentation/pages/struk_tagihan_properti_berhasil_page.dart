...
class StrukTagihanPropertiBerhasilPage extends StatefulWidget {
  final String noRef;
  final Map<String, dynamic> invoiceData;
  final DateTime tanggal;

  const StrukTagihanPropertiBerhasilPage({
    super.key,
    required this.noRef,
  ...
  @override
  State<StrukTagihanPropertiBerhasilPage> createState() =>
      _StrukTagihanPropertiBerhasilPageState();
}

class _StrukTagihanPropertiBerhasilPageState
    extends State<StrukTagihanPropertiBerhasilPage> {
  ...
  Future<void> _saveTransaction() async {
    final transaction = SavedTransaction(
      id: widget.noRef,
      name: "Bayar IPL & Properti",
      customerNumber: widget.invoiceData['nomorPelanggan'] ?? '',
      date: widget.tanggal,
    );
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const Properti1Page(),
                          ),
                        );
                      },
                    ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildRow("Jenis Transaksi", "Bayar IPL & Properti"),
                  const SizedBox(height: 12),
                  _buildRow("Nama", "ALFIN CHIPMUNK"),
                  const SizedBox(height: 12),
                  _buildRow("Nomor Pelanggan", "0012345"),
                  const SizedBox(height: 12),
                  if (_showDetails) ...[
                    _buildRow(
                      "Alamat",
                      "CitraLand BSB Semarang, Cluster Havana Blok A3 No. 15 Mijen, Semarang",
                    ),
                    const SizedBox(height: 12),
                    _buildRow("Periode Tagihan", "Bulanan"),
                    const SizedBox(height: 12),
                    _buildRow("Tanggal", "20 Agustus 2026"),
                    const SizedBox(height: 12),
                  ],
                  InkWell(
                    onTap: () {
