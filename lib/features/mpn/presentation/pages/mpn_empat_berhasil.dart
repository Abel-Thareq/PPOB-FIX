...
// Definisi kelas untuk halaman transaksi MPN berhasil
class MpnEmpatBerhasil extends StatefulWidget {
  final String billingCode;
  final String totalTagihan;

  const MpnEmpatBerhasil({
    super.key,
  ...
  @override
  State<MpnEmpatBerhasil> createState() => _MpnEmpatBerhasilState();
}

class _MpnEmpatBerhasilState extends State<MpnEmpatBerhasil> {
  // Format mata uang
