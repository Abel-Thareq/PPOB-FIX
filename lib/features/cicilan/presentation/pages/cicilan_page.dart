...
// Import halaman baru untuk transaksi cicilan
// Contoh: import 'package:ppob_app/features/cicilan/presentation/pages/cicilan_dua.dart';
                    ...
                    const Center(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'melakukan pembayaran Cicilan Finance.',
                            style: TextStyle(color: Colors.grey),
                          ),
                          SizedBox(height: 4),
                          Text(
              ...
              child: CustomButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const CicilanDuaPage(),
                    ),
                  );
                },
              ),
