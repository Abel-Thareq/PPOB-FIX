...
import 'package:ppob_app/features/cicilan/presentation/pages/cicilan_lima_berhasil.dart';
import 'package:ppob_app/features/cicilan/presentation/pages/cicilan_lima_gagal.dart';

class CicilanEmpatPage extends StatefulWidget {
  ...
  @override
  State<CicilanEmpatPage> createState() => _CicilanEmpatPageState();
}

class _CicilanEmpatPageState extends State<CicilanEmpatPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
         Navigator.push(
           context,
           MaterialPageRoute(
             builder: (context) => CicilanLimaBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
           builder: (context) => CicilanLimaGagal(
            selectedProviderName: widget.selectedProviderName,
                        nomorPelanggan: widget.nomorPelanggan,
                        totalTagihan: widget.totalTagihan,
                        biayaAdmin: widget.biayaAdmin,
