...
import 'package:ppob_app/features/emoney/presentation/pages/mandiriemoney_lima_berhasil.dart';
import 'package:ppob_app/features/emoney/presentation/pages/mandiriemoney_lima_gagal.dart';
import 'package:intl/intl.dart';

class MandiriEmoneyEmpatPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;
  final String cardNumber; // Tambahkan properti untuk menerima cardNumber

  const MandiriEmoneyEmpatPage({
    super.key,
    required this.totalPesanan,
    required this.biayaAdmin,
    required this.cardNumber, // Tambahkan ke konstruktor
  });

  @override
  State<MandiriEmoneyEmpatPage> createState() => _MandiriEmoneyEmpatPageState();
}

class _MandiriEmoneyEmpatPageState extends State<MandiriEmoneyEmpatPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => MandiriEmoneyLimaBerhasilPage(
              totalPesanan: widget.totalPesanan,
              biayaAdmin: widget.biayaAdmin,
              cardNumber: widget.cardNumber, // Teruskan cardNumber
            ),
          ),
        );
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => MandiriEmoneyLimaGagalPage(),
          ),
        );
      } else {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  // Menghapus widget Text yang menampilkan totalPesanan dan biayaAdmin
                  // Text(
