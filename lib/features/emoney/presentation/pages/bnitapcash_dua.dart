...
import 'package:ppob_app/features/emoney/presentation/pages/bnitapcash_tiga.dart';
import 'package:intl/intl.dart';

class BniTapCashDuaPage extends StatelessWidget {
  const BniTapCashDuaPage({super.key});
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BniTapCashTigaPage(nominal: nominal), // Meneruskan nominal ke BrizziTigaPage
              ),
            );
          },
          child: Padding(
