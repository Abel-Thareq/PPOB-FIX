...
import 'package:ppob_app/features/emoney/presentation/pages/mandiri_emoney_empat.dart';

class MandiriEmoneyTigaPage extends StatefulWidget {
  final int nominal;
  final String cardNumber;

  const MandiriEmoneyTigaPage({super.key, required this.nominal, required this.cardNumber});

  @override
  State<MandiriEmoneyTigaPage> createState() => _MandiriEmoneyTigaPageState();
}

class _MandiriEmoneyTigaPageState extends State<MandiriEmoneyTigaPage> {
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4.h),
                                  Text(
                                    formattedCardNumber, // Menggunakan nomor kartu yang dikirimkan
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MandiriEmoneyEmpatPage(
