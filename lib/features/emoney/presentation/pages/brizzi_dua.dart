...
class BrizziDuaPage extends StatelessWidget {
  const BrizziDuaPage({super.key});
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BrizziTigaPage(nominal: nominal), // Meneruskan nominal ke BrizziTigaPage
              ),
            );
          },
          child: Padding(
