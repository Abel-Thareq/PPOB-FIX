...
import 'package:ppob_app/features/emoney/presentation/pages/brizzi_lima_gagal.dart'; // Halaman gagal
import 'package:ppob_app/features/emoney/presentation/pages/brizzi_lima_berhasil.dart'; // Halaman berhasil
import 'package:intl/intl.dart';

class BrizziEmpatPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;

  const BrizziEmpatPage({
    super.key,
  ...
  @override
  State<BrizziEmpatPage> createState() => _BrizziEmpatPageState();
}

class _BrizziEmpatPageState extends State<BrizziEmpatPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => BrizziLimaBerhasilPage(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const BrizziLimaGagalPage(),
          ),
        );
      } else {
