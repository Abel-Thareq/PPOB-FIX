...
import 'package:ppob_app/features/emoney/presentation/pages/bnitapcash_lima_berhasil.dart';
import 'package:ppob_app/features/emoney/presentation/pages/bnitapcash_lima_gagal.dart';
import 'package:intl/intl.dart';

class BniTapCashEmpatPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;

  const BniTapCashEmpatPage({
    super.key,
  ...
  @override
  State<BniTapCashEmpatPage> createState() => _BniTapCashEmpatPageState();
}

class _BniTapCashEmpatPageState extends State<BniTapCashEmpatPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => BniLimaBerhasilPage(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const BniLimaGagalPage(),
          ),
        );
      } else {
