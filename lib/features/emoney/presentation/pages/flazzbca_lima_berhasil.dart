...
class FlazzBcaLimaBerhasilPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;
  final String cardNumber;

  const FlazzBcaLimaBerhasilPage({
    super.key,
  ...
  @override
  State<FlazzBcaLimaBerhasilPage> createState() => _FlazzBcaLimaBerhasilPageState();
}

class _FlazzBcaLimaBerhasilPageState extends State<FlazzBcaLimaBerhasilPage> {
  ...
  Widget build(BuildContext context) {
    // Mengakses properti dari widget induk menggunakan 'widget.'
    ...
    return PopScope(
      canPop: false, // Menonaktifkan perilaku default
      onPopInvoked: (didPop) {
        if (didPop) {
          return;
        }
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Image.asset('assets/images/flazz.png', width: 36, height: 36),
                              const SizedBox(width: 10),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text("Flazz BCA",
                                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
