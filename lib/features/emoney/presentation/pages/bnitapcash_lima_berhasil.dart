...
class BniLimaBerhasilPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;

  const BniLimaBerhasilPage({
    super.key,
  ...
  @override
  State<BniLimaBerhasilPage> createState() => _BniLimaBerhasilPageState();
}

class _BniLimaBerhasilPageState extends State<BniLimaBerhasilPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      // canPop: false menonaktifkan perilaku default tombol kembali perangkat.
      canPop: false,
      onPopInvoked: (didPop) {
        if (didPop) {
          return;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Icon BNI TapCash (menggunakan aset yang sesuai)
                              Image.asset('assets/images/bnitapcash.png', width: 36, height: 36),
