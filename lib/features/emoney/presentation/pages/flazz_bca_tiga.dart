...
import 'package:ppob_app/features/emoney/presentation/pages/flazz_bca_empat.dart';

class FlazzBcaTigaPage extends StatefulWidget {
  // Properti untuk menerima nominal dan nomor kartu
  final int nominal;
  final String cardNumber; // <-- Properti yang diterima dari halaman sebelumnya

  const FlazzBcaTigaPage({
    super.key,
  ...
  @override
  State<FlazzBcaTigaPage> createState() => _FlazzBcaTigaPageState();
}

class _FlazzBcaTigaPageState extends State<FlazzBcaTigaPage> {
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4.h),
                                  // Menampilkan nomor kartu yang telah diformat
                                  Text(
                                    formattedCardNumber,
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => FlazzBcaEmpatPage(
                          totalPesanan: totalPesanan,
                          biayaAdmin: biayaAdmin,
                          cardNumber: widget.cardNumber, // <-- Perubahan di sini
                        )),
                      );
                    },
                    child: Text(
