...
class MandiriEmoneyLimaBerhasilPage extends StatefulWidget {
  final int totalPesanan;
  final int biayaAdmin;
  final String cardNumber;

  const MandiriEmoneyLimaBerhasilPage({
    super.key,
  ...
  @override
  State<MandiriEmoneyLimaBerhasilPage> createState() => _MandiriEmoneyLimaBerhasilPageState();
}

class _MandiriEmoneyLimaBerhasilPageState extends State<MandiriEmoneyLimaBerhasilPage> {
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Image.asset('assets/images/mandiriemoney.png', width: 36, height: 36),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(widget.cardNumber, // Menggunakan properti widget.cardNumber
