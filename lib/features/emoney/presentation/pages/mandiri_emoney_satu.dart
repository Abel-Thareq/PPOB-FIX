...
import 'dart:async';
import 'package:ppob_app/features/emoney/presentation/pages/mandiri_emoney_dua.dart';
...
class MandiriEmoneySatuPage extends StatefulWidget {
  const MandiriEmoneySatuPage({super.key});

  @override
  State<MandiriEmoneySatuPage> createState() => _MandiriEmoneySatuPageState();
}

class _MandiriEmoneySatuPageState extends State<MandiriEmoneySatuPage> {
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Masukkan Nomor Mandiri E-Money',
    ...
    children: [
      ...
      ElevatedButton(
        onPressed: () {
          ...
          // Mengirimkan nomor kartu ke halaman berikutnya
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => MandiriEmoneyDuaPage(cardNumber: cardNumber),
            ),
          );
        },
        style: ElevatedButton.styleFrom(
