...
import 'package:ppob_app/features/emoney/presentation/pages/bnitapcash_dua.dart';
import 'dart:async';
...
class BniTapCashSatuPage extends StatefulWidget {
  const BniTapCashSatuPage({super.key});

  @override
  State<BniTapCashSatuPage> createState() => _BniTapCashSatuPageState();
}

class _BniTapCashSatuPageState extends State<BniTapCashSatuPage> {
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Masukkan Nomor TapCash',
    ...
    children: [
      ...
      ElevatedButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const BniTapCashDuaPage()),
          );
        },
        style: ElevatedButton.styleFrom(
