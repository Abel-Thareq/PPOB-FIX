...
import 'package:ppob_app/features/emoney/presentation/pages/bnitapcash_empat.dart';

class BniTapCashTigaPage extends StatefulWidget {
  final int nominal; // Properti baru untuk menerima nominal

  const BniTapCashTigaPage({super.key, required this.nominal});

  @override
  State<BniTapCashTigaPage> createState() => _BniTapCashTigaPageState();
}

class _BniTapCashTigaPageState extends State<BniTapCashTigaPage> {
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Image.asset(
                              'assets/images/bnitapcash.png', // Logo BRIZZI
                              width: 50.w,
                              height: 40.h,
                            ),
                            SizedBox(width: 12.w),
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BniTapCashEmpatPage(
