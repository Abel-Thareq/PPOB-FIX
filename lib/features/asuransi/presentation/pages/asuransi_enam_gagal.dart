...
class AsuransiEnamGagal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        // Gunakan Stack untuk mengatur tata letak header and konten
        body: Stack(
          children: [
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: CustomButton(
                              text: 'Coba Lagi',
                              onPressed: () {
                                // Navigasi ke AsuransiDuaPage dan hapus rute saat ini
