...
class AsuransiEnamBerhasil extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String sumberDanaNomor = "08725633863";

    return PopScope(
      canPop: false, // Mencegah pop default saat tombol kembali ditekan
      onPopInvoked: (didPop) {
        if (!didPop) {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            // Konten halaman di lapisan bawah
            Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Lingkaran ikon centang yang benar-benar bulat
                    Container(
                      width: 50.r,
                      height: 50.r,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _DetailRow("Jenis Transaksi", "Pembayaran Asuransi"),
                          _DetailRow("Nama Pemegang", namaPemegang),
                          _DetailRow("Nomor Polis", policyNumber),
                          Divider(height: 24.h, thickness: 1),
                          _DetailRow("Harga", formatCurrency(tagihan)),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  formatCurrency(tagihan + biayaAdmin),
                                  style: TextStyle(
                                    fontSize: 14.sp,
                                    fontWeight: FontWeight.bold,
            ...
            // Header yang diperkecil ukurannya
            SizedBox(
              height: headerHeight,
