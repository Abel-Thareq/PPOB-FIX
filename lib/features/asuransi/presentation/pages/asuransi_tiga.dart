...
import 'package:ppob_app/features/asuransi/presentation/pages/asuransi_empat.dart';
...
class AsuransiTigaPage extends StatefulWidget {
  ...
  const AsuransiTigaPage({
    super.key,
    required this.insuranceType,
    required this.paymentType,
    required this.policyNumber,
    required this.insuranceIconPaths,
    this.namaPemegang = "ALFIN CHIPMUNK",
    this.tagihan = 400000,
    this.biayaAdmin = 0,
  });

  @override
  State<AsuransiTigaPage> createState() => _AsuransiTigaPageState();
}

class _AsuransiTigaPageState extends State<AsuransiTigaPage> {
  ...
  void initState() {
    ...
    _inputNominalController = TextEditingController(
        text: _formatCurrencyInput(widget.tagihan + widget.biayaAdmin));
    ...
    setState(() {
      ...
      if (option == 'Bayar Penuh') {
        _inputNominalController.text =
            _formatCurrencyInput(widget.tagihan + widget.biayaAdmin);
      } else if (option == 'Bayar Minimal') {
        int minimalPembayaran = (widget.tagihan * 0.1).round();
        _inputNominalController.text =
  ...
  Widget build(BuildContext context) {
    ...
    int totalTagihan = widget.tagihan + widget.biayaAdmin;
    int minimalPembayaran = (widget.tagihan * 0.1).round();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        _DetailRow("Sumber Dana", "ABEL THAREO", value2: "08725633863"),
                        _DetailRow("Nama Pemegang", widget.namaPemegang),
                        _DetailRow("Nomor Polis", widget.policyNumber),
                        _DetailRow("Pembayaran", widget.insuranceType),
                        _DetailRow("Tipe Pembayaran", widget.paymentType),
                        const Divider(height: 24, thickness: 1),
                        _DetailRow("Tagihan", formatCurrency(widget.tagihan)),
              ...
              child: CustomButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AsuransiEmpatPage(
                        ...
                        insuranceIconPaths: widget.insuranceIconPaths,
                      ),
                    ),
                  );
                },
