...
class KaiEnamBerhasil extends StatefulWidget {
  final int nominalTagihan;
  final int biayaAdmin;
  final String namaPelanggan;
  final String kodeBayar;

  const KaiEnamBerhasil({
    super.key,
  ...
  @override
  State<KaiEnamBerhasil> createState() => _KaiEnamBerhasilState();
}

class _KaiEnamBerhasilState extends State<KaiEnamBerhasil> {
  // Format mata uang
