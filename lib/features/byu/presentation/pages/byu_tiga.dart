...
import 'byu_empat_berhasil.dart'; // Import halaman berhasil
import 'byu_empat_gagal.dart'; // Import halaman gagal

class ByuTigaPage extends StatefulWidget {
  ...
  @override
  State<ByuTigaPage> createState() => _ByuTigaPageState();
}

class _ByuTigaPageState extends State<ByuTigaPage> {
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ByuEmpatBerhasil(selectedPromo: widget.selectedPromo),
          ),
        );
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ByuEmpatGagal(selectedPromo: widget.selectedPromo),
          ),
        );
      } else {
