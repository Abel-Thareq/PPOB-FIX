...
class ByuEmpatBerhasil extends StatefulWidget {
  final Map<String, dynamic> selectedPromo;

  const ByuEmpatBerhasil({
    super.key,
    required this.selectedPromo,
  });

  @override
  State<ByuEmpatBerhasil> createState() => _ByuEmpatBerhasilState();
}

class _ByuEmpatBerhasilState extends State<ByuEmpatBerhasil> {
  ...
  void _shareTransactionDetails() {
    ...
    final totalPembelian = formatCurrency(widget.selectedPromo['price']);
...
Jenis Transaksi: by.u promo
Nomor Tujuan: ${getValue(widget.selectedPromo['phoneNumber'])}
Paket: ${getValue(widget.selectedPromo['title'])}
Harga: ${formatCurrency(widget.selectedPromo['details']['nominal'])}
Biaya Admin: ${formatCurrency(widget.selectedPromo['details']['biayaAdmin'])}
