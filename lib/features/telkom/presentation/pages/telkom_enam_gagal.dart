...
// Ganti dengan path ke halaman TelkomDuaPage Anda
import 'package:ppob_app/features/telkom/presentation/pages/telkom_dua.dart';

class TelkomEnamGagal extends StatefulWidget {
  final int nominalTagihan;
  final int biayaAdmin;
  final String namaPelanggan;
  final String nomorPelanggan;

  const TelkomEnamGagal({
    super.key,
  ...
  @override
  State<TelkomEnamGagal> createState() => _TelkomEnamGagalState();
}

class _TelkomEnamGagalState extends State<TelkomEnamGagal> {
  ...
  void _onTryAgainPressed() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const TelkomDuaPage()),
    );
  }
