...
import 'package:ppob_app/features/telkom/presentation/pages/telkom_tiga.dart';

class TelkomDuaPage extends StatefulWidget {
  const TelkomDuaPage({super.key});

  @override
  State<TelkomDuaPage> createState() => _TelkomDuaPageState();
}

class _TelkomDuaPageState extends State<TelkomDuaPage> {
  ...
  void _updateButtonState() {
    final bool isNomorPelangganFilled = _nomorPelangganController.text.isNotEmpty;
    setState(() {
      _isButtonEnabled = isNomorPelangganFilled;
    });
  }
          ...
          child: ElevatedButton(
            onPressed: _isButtonEnabled ? () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TelkomTigaPage(
