...
class TelkomEnamBerhasil extends StatefulWidget {
  final int nominalTagihan;
  final int biayaAdmin;
  final String namaPelanggan;
  final String nomorPelanggan;

  const TelkomEnamBerhasil({
    super.key,
  ...
  @override
  State<TelkomEnamBerhasil> createState() => _TelkomEnamBerhasilState();
}

class _TelkomEnamBerhasilState extends State<TelkomEnamBerhasil> {
  // Format mata uang
