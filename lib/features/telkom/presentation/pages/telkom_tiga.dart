...
import 'package:ppob_app/features/telkom/presentation/pages/telkom_empat.dart';
//import 'package:ppob_app/features/telkom/presentation/pages/telkom_empat.dart';

class TelkomTigaPage extends StatefulWidget {
  final String nomorPelanggan;

  const TelkomTigaPage({
    super.key,
    required this.nomorPelanggan,
  });

  @override
  State<TelkomTigaPage> createState() => _TelkomTigaPageState();
}

class _TelkomTigaPageState extends State<TelkomTigaPage> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _DetailRow("Tipe Pelanggan", tipePelanggan),
                      _DetailRow("Periode Tagihan", periodeTagihan),
                      _DetailRow("Total Periode", totalPeriode.toString()),
              ...
              child: CustomButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => TelkomEmpatPage(
