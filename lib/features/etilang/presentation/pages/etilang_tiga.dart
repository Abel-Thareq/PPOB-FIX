...
import 'package:ppob_app/features/etilang/presentation/pages/etilang_empat_berhasil.dart';
import 'package:ppob_app/features/etilang/presentation/pages/etilang_empat_gagal.dart';

class EtilangTigaPage extends StatefulWidget {
  final String billingCode;
  final String totalTagihan;

  const EtilangTigaPage({
    super.key,
  ...
  @override
  State<EtilangTigaPage> createState() => _EtilangTigaPageState();
}

class _EtilangTigaPageState extends State<EtilangTigaPage> {
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => EtilangEmpatBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => EtilangEmpatGagal(
              billingCode: widget.billingCode,
              totalTagihan: widget.totalTagihan,
            ),
          ),
