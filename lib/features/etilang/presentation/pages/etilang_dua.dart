...
// Import halaman tujuan, diasumsikan EtilangTigaPage sudah ada
import 'package:ppob_app/features/etilang/presentation/pages/etilang_tiga.dart';

class EtilangDuaPage extends StatefulWidget {
  final String billingCode;

  const EtilangDuaPage({
    super.key,
    required this.billingCode,
  });

  @override
  State<EtilangDuaPage> createState() => _EtilangDuaPageState();
}

class _EtilangDuaPageState extends State<EtilangDuaPage> {
  ...
  final int totalDenda = 250000;
  final int biayaAdmin = 1000;
  final String namaPelanggar = "Joko Santoso";
  final String alamatPelanggar = "Jl. Sudirman No. 12, Jakarta";
  final String nomorTilang = "9876543210";
  ...
  Widget build(BuildContext context) {
    ...
    final totalPembayaran = totalDenda + biayaAdmin;
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DetailRow("Kode Bayar Tilang", widget.billingCode),
                        _DetailRow("Nama Pelanggar", namaPelanggar),
                        _DetailRow("Alamat Pelanggar", alamatPelanggar),
                        _DetailRow("Nomor Tilang", nomorTilang),
                        _DetailRow("Jumlah Detail", jumlahDetail),
                        SizedBox(height: 16.h),
                        Divider(height: 1.h, thickness: 1, color: Colors.grey.shade300),
                        SizedBox(height: 16.h),
                        _DetailRow("Denda", formatCurrency(totalDenda)),
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EtilangTigaPage(
                      billingCode: widget.billingCode,
                      totalTagihan: formatCurrency(totalDenda),
                    ),
                  ),
                );
              },
