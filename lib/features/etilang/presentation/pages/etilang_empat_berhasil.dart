...
class EtilangEmpatBerhasil extends StatefulWidget {
  final String billingCode;
  final String totalTagihan;

  const EtilangEmpatBerhasil({
    super.key,
  ...
  @override
  State<EtilangEmpatBerhasil> createState() => _EtilangEmpatBerhasilState();
}

class _EtilangEmpatBerhasilState extends State<EtilangEmpatBerhasil> {
  // Format mata uang
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Bagian Sumber Dana
                        _DetailRow("Sumber Dana", "ABEL THAREO"),
                        ...
                        _DetailRow("Jenis Transaksi", "Bayar E-Tilang"),
                        const SizedBox(height: 12),
                        const Divider(height: 1, color: Colors.grey),
                        const SizedBox(height: 12),
                        ...
                        _DetailRow("Nama Pelanggar", "ALFIN CHIPMUNK"),
                        const SizedBox(height: 12),
                        const Divider(height: 1, color: Colors.grey),
                        const SizedBox(height: 12),
                        
                        // Bagian Harga, Denda, dan Biaya Admin
                        _DetailRow("Harga", formatCurrency(500000)),
