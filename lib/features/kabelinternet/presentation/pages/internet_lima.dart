...
import 'internet_enam_berhasil.dart'; // Import halaman berhasil
import 'internet_enam_gagal.dart'; // Import halaman gagal

class InternetLimaPage extends StatefulWidget {
  final String selectedService;
  final String customerNumber;
  final Map<String, dynamic> selectedPackage;

  const InternetLimaPage({
    super.key,
  ...
  @override
  State<InternetLimaPage> createState() => _InternetLimaPageState();
}

class _InternetLimaPageState extends State<InternetLimaPage> {
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InternetEnamBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InternetEnamGagal(
              selectedService: widget.selectedService,
              customerNumber: widget.customerNumber,
              selectedPackage: widget.selectedPackage,
            ),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 4.h),
            Text(
              "SATISFIRST SESSION / FAMILY NAME",
              style: TextStyle(
                fontSize: 12.sp,
