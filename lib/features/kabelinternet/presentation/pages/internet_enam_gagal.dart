...
import 'package:ppob_app/features/kabelinternet/presentation/pages/internet_dua.dart';
import 'package:ppob_app/features/main_screen/main_screen.dart';
import 'dart:math';

class InternetEnamGagal extends StatefulWidget {
  final String selectedService;
  final String customerNumber;
  final Map<String, dynamic> selectedPackage;

  const InternetEnamGagal({
    super.key,
  ...
  @override
  State<InternetEnamGagal> createState() => _InternetEnamGagalState();
}

class _InternetEnamGagalState extends State<InternetEnamGagal> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushAndRemoveUntil(
                              context,
                              MaterialPageRoute(
                                builder: (context) => InternetDuaPage(),
                              ),
                              (Route<dynamic> route) => false,
                            );
                          },
