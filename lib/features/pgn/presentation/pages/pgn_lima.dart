...
import 'package:ppob_app/features/pgn/presentation/pages/pgn_enam_berhasil.dart';
import 'package:ppob_app/features/pgn/presentation/pages/pgn_enam_gagal.dart';
// import 'pgn_enam_berhasil.dart'; // Import halaman berhasil untuk PGN
// import 'pgn_enam_gagal.dart'; // Import halaman gagal untuk PGN

class PgnLimaPage extends StatefulWidget {
  ...
  @override
  State<PgnLimaPage> createState() => _PgnLimaPageState();
}

class _PgnLimaPageState extends State<PgnLimaPage> {
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PgnEnamBerhasil(
