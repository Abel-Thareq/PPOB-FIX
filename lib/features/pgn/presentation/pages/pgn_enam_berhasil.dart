...
class PgnEnamBerhasil extends StatefulWidget {
  final int nominalTagihan;
  final int biayaAdmin;
  final String namaPelanggan;
  final String nomorPelanggan;

  const PgnEnamBerhasil({
    super.key,
  ...
  @override
  State<PgnEnamBerhasil> createState() => _PgnEnamBerhasilState();
}

class _PgnEnamBerhasilState extends State<PgnEnamBerhasil> {
  // Format mata uang
  ...
  void _shareTransactionDetails() {
    ...
    Detail Pembayaran PGN:
    ----------------------------------------
    Tanggal: $formattedDate
    No. Ref: $noRef
    Sumber Dana: ${widget.namaPelanggan}
    Jenis Transaksi: Bayar PGN
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            // Header dengan gambar latar belakang - DIPINDAH KE BAWAH
            // Konten utama
            ...
            // HEADER dan TOMBOL - DIPINDAH KE ATAS (DI AKHIR STACK)
            // Header dengan gambar latar belakang
            Container(
              height: 120, // Tinggi header diperbesar
            ...
            Positioned(
              top: 43, // Posisi lebih rendah
              left: 19, // Memberi ruang lebih di kiri
              child: Container(
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                ),
                child: IconButton(
                  ...
                  color: Colors.white,
                  iconSize: 28, // Ukuran icon diperbesar
                  padding: const EdgeInsets.all(12), // Area tap diperbesar
                  onPressed: _onBackPressed,
                ),
              ),
            ),
