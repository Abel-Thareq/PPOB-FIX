...
import 'package:ppob_app/features/pgn/presentation/pages/pgn_tiga.dart';

class PgnDuaPage extends StatefulWidget {
  const PgnDuaPage({super.key});

  @override
  State<PgnDuaPage> createState() => _PgnDuaPageState();
}

class _PgnDuaPageState extends State<PgnDuaPage> {
