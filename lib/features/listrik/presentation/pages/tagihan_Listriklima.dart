...
class TagihanListrikLima extends StatefulWidget {
  ...
  @override
  State<TagihanListrikLima> createState() => _TagihanListrikLimaState();
}

class _TagihanListrikLimaState extends State<TagihanListrikLima> {
    ...
    try {
      ...
      if (imageBytes != null) {
        ...
        final xFile = XFile.fromData(
          imageBytes,
          name: 'bukti_tagihan_listrik_${DateTime.now().millisecondsSinceEpoch}.png',
          mimeType: 'image/png',
        );

        await Share.shareXFiles(
          [xFile],
          text: 'Bukti Pembayaran Tagihan Listrik - ${generateReferenceNumber()}',
        );
      } else {
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    // Informasi khusus Tagihan Listrik
                                    const Divider(height: 20),
                                    _DetailRow("IDPEL", _extractIdPel(widget.meterNumber)),
                                    _DetailRow("NAMA PELANGGAN", widget.customerName),
                                    ...
                                    const Divider(height: 12),
                                    _DetailRow("RP TAG PLN", formatCurrency(widget.totalPesanan - widget.biayaAdmin)),
                                    _DetailRow("BIAYA ADMIN", formatCurrency(widget.biayaAdmin)),
                                    _DetailRow("TOTAL TRANSAKSI", formatCurrency(widget.totalPembayaran), isBold: true),
