...
class TokenListrikLimaPage extends StatefulWidget {
  ...
  @override
  State<TokenListrikLimaPage> createState() => _TokenListrikLimaPageState();
}

class _TokenListrikLimaPageState extends State<TokenListrikLimaPage> {
    ...
    try {
      ...
      if (imageBytes != null) {
        ...
        final xFile = XFile.fromData(
          imageBytes,
          name: 'bukti_token_listrik_${DateTime.now().millisecondsSinceEpoch}.png',
          mimeType: 'image/png',
        );

        await Share.shareXFiles(
          [xFile],
          text: 'Bukti Pembayaran Token Listrik - ${generateReferenceNumber()}',
        );
      } else {
  ...
  void _showFallbackShare() {
    final shareText = '''
🔋 BUKTI PEMBAYARAN TOKEN LISTRIK
