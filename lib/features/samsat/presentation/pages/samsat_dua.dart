...
import 'package:ppob_app/features/samsat/presentation/pages/samsat_tiga.dart';

class SamsatDuaPage extends StatefulWidget {
  ...
  @override
  State<SamsatDuaPage> createState() => _SamsatDuaPageState();
}

class _SamsatDuaPageState extends State<SamsatDuaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const String namaPemilik = 'Budi Santoso';
    const String nomorPolisi = 'B 1234 ABC';
    const String jatuhTempo = '2025-12-31';
    const int tagihan = 250000;
    const int biayaAdmin = 2500;
    const int totalTagihan = tagihan + biayaAdmin;
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      _DetailRow("Provinsi", widget.provinsi),
                      _DetailRow("Kode Pembayaran", widget.kodePembayaran),
                      const Divider(height: 24, thickness: 1),
                      _DetailRow("Nama Pemilik", namaPemilik),
                      _DetailRow("Nomor Polisi", nomorPolisi),
                      _DetailRow("Jatuh Tempo", jatuhTempo),
                      const Divider(height: 24, thickness: 1),
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SamsatTigaPage(
