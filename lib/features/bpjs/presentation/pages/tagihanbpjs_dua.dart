...
// Import halaman sukses dan gagal BPJS
import 'package:ppob_app/features/bpjs/presentation/pages/tagihanbpjs_tiga_berhasil.dart';
import 'package:ppob_app/features/bpjs/presentation/pages/tagihanbpjs_tiga_gagal.dart';

class TagihanBpjsDuaPage extends StatefulWidget {
  ...
  @override
  State<TagihanBpjsDuaPage> createState() => _TagihanBpjsDuaPageState();
}

class _TagihanBpjsDuaPageState extends State<TagihanBpjsDuaPage> {
  String enteredPin = '';
    ...
    if (enteredPin.length == pinLength) {
      ...
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TagihanBpjsTigaBerhasilPage(
              totalPesanan: widget.totalPesanan,
              biayaAdmin: widget.biayaAdmin,
              jenisBpjs: widget.jenisBpjs, // Mengirimkan jenis BPJS
              nomorPembayaran: widget.nomorPembayaran, // Mengirimkan nomor pembayaran
            ),
          ),
        );
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TagihanBpjsTigaGagalPage(
              totalPesanan: widget.totalPesanan,
              biayaAdmin: widget.biayaAdmin,
              jenisBpjs: widget.jenisBpjs, // Mengirimkan jenis BPJS
