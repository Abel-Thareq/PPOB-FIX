...
class TagihanBpjsTigaGagalPage extends StatelessWidget {
  ...
  const TagihanBpjsTigaGagalPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        // Atur AppBar agar transparan dan tidak memiliki bayangan.
        // Ini akan menempatkan tombol kembali standar di posisi yang aman.
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
                // Logika navigasi untuk tombol kembali di AppBar
                Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(builder: (context) => const MainScreen()),
                      (Route<dynamic> route) => false,
        ...
        // Atur body agar berada di belakang AppBar
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: CustomButton(
                            text: 'Kembali',
                            onPressed: () {
                              // Navigasi ke MainScreen dan menghapus rute lainnya
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(builder: (context) => const MainScreen()),
                                    (Route<dynamic> route) => false,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: CustomButton(
                            text: 'Coba Lagi',
                            onPressed: () {
                              // Navigasi ke ProdukBpjsPage dan menghapus rute lainnya
                              Navigator.pushAndRemoveUntil(
                                context,
