...
class WakafTujuhGagal extends StatefulWidget {
  final WakafModel wakaf;
  final int selectedAmount;
  final String selectedLabel;

  const WakafTujuhGagal({
    Key? key,
    required this.wakaf,
  ...
  @override
  State<WakafTujuhGagal> createState() => _WakafTujuhGagalState();
}

class _WakafTujuhGagalState extends State<WakafTujuhGagal> {
