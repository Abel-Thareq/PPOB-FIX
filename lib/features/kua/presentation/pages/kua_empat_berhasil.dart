...
class KuaEmpatBerhasil extends StatefulWidget {
  final String billingCode;
  final String totalTagihan;

  const KuaEmpatBerhasil({
    super.key,
  ...
  @override
  State<KuaEmpatBerhasil> createState() => _KuaEmpatBerhasilState();
}

class _KuaEmpatBerhasilState extends State<KuaEmpatBerhasil> {
  // Format mata uang
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DetailRow("Jenis Transaksi", "Bayar KUA"),
                        const SizedBox(height: 12),
                        const Divider(height: 1, color: Colors.grey),
                        const SizedBox(height: 12),
