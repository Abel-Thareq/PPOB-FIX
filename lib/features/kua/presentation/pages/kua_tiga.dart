...
import 'package:ppob_app/features/kua/presentation/pages/kua_empat_berhasil.dart';
import 'package:ppob_app/features/kua/presentation/pages/kua_empat_gagal.dart';

class KuaTigaPage extends StatefulWidget {
  ...
  @override
  State<KuaTigaPage> createState() => _KuaTigaPageState();
}

class _KuaTigaPageState extends State<KuaTigaPage> {
    ...
    if (enteredPin.length == pinLength) {
      if (enteredPin == '555555') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => KuaEmpatBerhasil(
