...
import 'package:ppob_app/features/ewallet/gopay/gopay3_page.dart';

class Gopay2Page extends StatefulWidget {
  const Gopay2Page({super.key});

  @override
  State<Gopay2Page> createState() => _Gopay2PageState();
}

class _Gopay2PageState extends State<Gopay2Page> {
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          height: 30,
                          child: Image.asset(
                            "assets/images/gopay_noborder.png",
                            fit: BoxFit.contain,
                          ),
                        ),
                        SizedBox(width: 10.w),
