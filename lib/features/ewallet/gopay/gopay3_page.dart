...
class Gopay3Page extends StatefulWidget {
  final String phoneNumber;
  const Gopay3Page({super.key, required this.phoneNumber});

  @override
  State<Gopay3Page> createState() => _Gopay3PageState();
}

class _Gopay3PageState extends State<Gopay3Page> {
  bool _isSaved = true;
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/gopay_noborder.png",
                              width: 40, height: 40),
                          SizedBox(width: 10.w),
                          Column(
