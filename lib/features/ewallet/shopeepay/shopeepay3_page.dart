...
class ShopeePay3Page extends StatefulWidget {
  final String phoneNumber;
  const ShopeePay3Page({super.key, required this.phoneNumber});

  @override
  State<ShopeePay3Page> createState() => _ShopeePay3PageState();
}

class _ShopeePay3PageState extends State<ShopeePay3Page> {
  bool _isSaved = true;
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/shopeepay_noborder.png",
                              width: 40, height: 40),
                          SizedBox(width: 10.w),
                          Column(
