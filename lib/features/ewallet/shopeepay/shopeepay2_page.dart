...
import 'package:ppob_app/features/ewallet/shopeepay/shopeepay3_page.dart';

class ShopeePay2Page extends StatefulWidget {
  const ShopeePay2Page({super.key});

  @override
  State<ShopeePay2Page> createState() => _ShopeePay2PageState();
}

class _ShopeePay2PageState extends State<ShopeePay2Page> {
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          height: 30,
                          child: Image.asset(
                            "assets/images/shopeepay_noborder.png",
                            fit: BoxFit.contain,
                          ),
                        ),
                        SizedBox(width: 10.w),
