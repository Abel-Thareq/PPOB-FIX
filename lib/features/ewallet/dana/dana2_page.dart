...
import 'package:ppob_app/features/ewallet/dana/dana3_page.dart';

class Dana2Page extends StatefulWidget {
  const Dana2Page({super.key});

  @override
  State<Dana2Page> createState() => _Dana2PageState();
}

class _Dana2PageState extends State<Dana2Page> {
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          height: 30,
                          child: Image.asset(
                            "assets/images/dana_noborder.png",
                            fit: BoxFit.contain,
                          ),
                        ),
                        SizedBox(width: 10.w),
