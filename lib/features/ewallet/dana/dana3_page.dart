...
class Dana3Page extends StatefulWidget {
  final String phoneNumber;
  const Dana3Page({super.key, required this.phoneNumber});

  @override
  State<Dana3Page> createState() => _Dana3PageState();
}

class _Dana3PageState extends State<Dana3Page> {
  bool _isSaved = true;
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/dana_noborder.png",
                              width: 40, height: 40),
                          SizedBox(width: 10.w),
                          Column(
