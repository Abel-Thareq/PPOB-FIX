...
import 'package:ppob_app/features/ewallet/linkaja/linkaja3_page.dart';

class LinkAja2Page extends StatefulWidget {
  const LinkAja2Page({super.key});

  @override
  State<LinkAja2Page> createState() => _LinkAja2PageState();
}

class _LinkAja2PageState extends State<LinkAja2Page> {
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          height: 30,
                          child: Image.asset(
                            "assets/images/linkaja_noborder.png",
                            fit: BoxFit.contain,
                          ),
                        ),
                        SizedBox(width: 10.w),
