...
import 'package:ppob_app/features/ewallet/linkaja/linkaja2_page.dart';

class LinkAjaPage extends StatelessWidget {
  const LinkAjaPage({super.key});
          ...
          Padding(
            ...
            child: CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const LinkAja2Page()),
                );
              },
            ),
          ),
