...
class Isaku3Page extends StatefulWidget {
  final String phoneNumber;
  const Isaku3Page({super.key, required this.phoneNumber});

  @override
  State<Isaku3Page> createState() => _Isaku3PageState();
}

class _Isaku3PageState extends State<Isaku3Page> {
  bool _isSaved = true;
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/isaku_noborder.png",
                              width: 40, height: 40),
                          SizedBox(width: 10.w),
                          Column(
