...
import 'package:ppob_app/features/ewallet/isaku/isaku2_page.dart';

class IsakuPage extends StatelessWidget {
  const IsakuPage({super.key});
          ...
          Padding(
            ...
            child: CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const Isaku2Page()),
                );
              },
            ),
          ),
