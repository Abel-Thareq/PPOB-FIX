...
class Ovo3Page extends StatefulWidget {
  final String phoneNumber;
  const Ovo3Page({super.key, required this.phoneNumber});

  @override
  State<Ovo3Page> createState() => _Ovo3PageState();
}

class _Ovo3PageState extends State<Ovo3Page> {
  bool _isSaved = true;
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/ovo_noborder.png",
                              width: 40, height: 40),
                          SizedBox(width: 10.w),
                          Column(
