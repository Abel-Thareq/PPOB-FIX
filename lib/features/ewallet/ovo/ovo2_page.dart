...
import 'package:ppob_app/features/ewallet/ovo/ovo3_page.dart';

class Ovo2Page extends StatefulWidget {
  const Ovo2Page({super.key});

  @override
  State<Ovo2Page> createState() => _Ovo2PageState();
}

class _Ovo2PageState extends State<Ovo2Page> {
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          height: 30,
                          child: Image.asset(
                            "assets/images/ovo_noborder.png",
                            fit: BoxFit.contain,
                          ),
                        ),
                        SizedBox(width: 10.w),
